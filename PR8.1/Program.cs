            ...
            while (true)
            {
                ...
                switch (q)
                {
                    ...
                    case 2:
                        if (In_Acc == false)
                        {
                            Console.WriteLine("ВОЙДИ В АККАУНТ, ИДИОТ");
                            break;
                        }
                        else
                        {
                    ...
                    case 3:
                        ...
                        {
                            var orders = Core.Context.Order.Where(o => o.ID_User == NewUser.ID).ToList();
                            Console.WriteLine("===ЗАКАЗЫ===");
                                foreach (var order in orders)
                                {

                                    var Us_Ord2 = order.Order_Product.ToList();
        ...
        class Shop
        {
            ...
            public void Buy(User NewUser, bool In_Acc)
            {
                ...
                else
                {
                    ...
                    if(Prod2 == null)
                    {
                        Console.WriteLine("Название неправильное!");
                    }
                    else
                    {
